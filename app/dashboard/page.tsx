...
const Dashboard = () => {
    useEffect(() => {
        ...
        script.src = "./db.js"; // Replace with actual script URL
        script.async = true;
                ...
                <div className="py-2 px-6 bg-[#f8f4f3] flex items-center shadow-md shadow-black/5 sticky top-0 left-0 z-30">
                    ...
                    <ul className="ml-auto flex items-center">
                        ...
                        <button id="fullscreen-button">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" className="hover:bg-gray-100 rounded-full" viewBox="0 0 24 24" style={{
                                "fill": "gray"
                            ...
                            <ul className="dropdown-menu shadow-md shadow-black/5 z-30 hidden py-1.5 rounded-md bg-white border border-gray-100 w-full max-w-[140px]">
                                ...
                                <li>
                                    <form method="POST" action="">
                                        <p className="flex items-center text-[13px] py-1.5 px-4 text-gray-600 hover:text-[#f84525] hover:bg-gray-50 cursor-pointer">
                                            Log Out
                                        </p>
                                    </form>
                                </li>
